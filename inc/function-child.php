...
function velocitychild_theme_setup()
{
    ...
    if (class_exists('Kirki')) :
        ...
        Kirki::add_panel('panel_toko30', [
            'priority'    => 10,
            'title'       => esc_html__('Velocity Toko 30', 'justg'),
...
if (!function_exists('justg_header_open')) {
    function justg_header_open()
    {
        ...
        echo '<div class="card rounded-0 border-light border-top-0 border-bottom-0 shadow container">';
    }
}
...
?>
    <article <?php post_class('col-md-3 col-6 p-2 mb-3'); ?> id="post-<?php the_ID(); ?>">
        <div class="card h-100 card-product">
            <?php echo do_shortcode("[thumbnail width='300' height='350' crop='false' upscale='true']");
            ?>
            <div class="p-3">
                ...
                <div class="row">
                    <div class="col-md-6 col-8 p-1 text-start"><a href="<?php the_permalink(); ?>" class="p-1 btn btn-primary w-100">Detail</a></div>
                    <div class="col-md-6 col-4 p-1 text-end">
                        <span class="cart-arsip p-1 w-100 btn btn-primary"><?php echo do_shortcode("[beli]"); ?></span>
                    </div>
                </div>
            </div>
        </div>
